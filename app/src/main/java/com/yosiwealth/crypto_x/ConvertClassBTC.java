...
public class ConvertClassBTC extends AppCompatActivity {
    ...
    Double exchangeRateUSD; Double exchangeRateEUR;
    Double exchangeRateNGN; Double exchangeRateCAD;
    Double exchangeRateGBP; Double exchangeRateCNY;
    Double exchangeRateCHF; Double exchangeRateAUD;
    Double exchangeRateJPY; Double exchangeRateSEK;
    Double exchangeRateMXN; Double exchangeRateNZD;
    Double exchangeRateSGD; Double exchangeRateHKD;
    Double exchangeRateNOK; Double exchangeRateTRY;
    Double exchangeRateRUB; Double exchangeRateZAR;
    Double exchangeRateBRL; Double exchangeRateMYR;

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.convert_activity_btc);
